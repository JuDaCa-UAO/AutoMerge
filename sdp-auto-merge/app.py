...
LANG = {
    "es": {
        ...
        "env_error": "No pude leer la configuracion: {error}",
        "env_info": "Define variables de entorno o usa Streamlit Secrets y vuelve a ejecutar.",
    ...
    "en": {
        ...
        "env_error": "Could not read configuration: {error}",
        "env_info": "Define environment variables or use Streamlit Secrets and try again.",
